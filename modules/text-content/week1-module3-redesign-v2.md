...
- Text blocks appear in clusters (3-4 min reading → another 4-5 min reading)
...
|-------|---------|----------------|------|--------|---------------------|
| 1 | **Text** 🔴 Required | Brief introduction (200 words) | 2 min | Import `week1-revenue-intro.md` | Sets up 5 streams concept |
| 2 | **Video** 🔴 Required | Overview of 5 revenue streams | 2 min | Upload `week1-video1-revenue-streams.mp4` | Visual introduction |
| 3 | **Vertical List** 🔴 Required | 5 revenue streams at a glance | 1 min | Type directly | Scannable reference |
| 4 | **Table** 🔴 Required | Revenue stream comparison matrix | 1 min | Type directly | Columns: Stream, Size, Growth, Risk |
| 5 | **Text** 🔴 Required | Media Rights Part 1: The Dominance (300 words) | 2 min | Import `week1-media-rights-part1.md` | Why media is 40-60% |
| 6 | **Image** 🟡 Recommended | Media rights deal timeline | 1 min | Upload `media-rights-timeline.png` | Major deals 2020-2025 |
| 7 | **Text** 🔴 Required | Media Rights Part 2: Streaming Wars (300 words) | 2 min | Import `week1-media-rights-part2.md` | Traditional vs streaming |
| 8 | **Infobox (Note)** 🔴 Required | "Appointment viewing" key insight | 1 min | Type directly | Yellow variant, critical concept |
| 9 | **Text** 🔴 Required | Ticketing Part 1: Live Experience (350 words) | 2 min | Import `week1-ticketing-part1.md` | Gate receipts, attendance |
| 10 | **Image** 🟡 Recommended | Premium seating revenue breakdown | 1 min | Upload `premium-seating-breakdown.png` | Visual model |
| 11 | **Text** 🔴 Required | Ticketing Part 2: Premium Strategy (350 words) | 2 min | Import `week1-ticketing-part2.md` | Suites, club seats, PSLs |
| 12 | **Video** 🔴 Required | Sponsorship & Merchandising in 2 minutes | 2 min | Upload `week1-video2-sponsorship-merch.mp4` | Visual break, covers 2 streams |
| 13 | **Text** 🔴 Required | Sponsorship Deep Dive (400 words) | 3 min | Import `week1-sponsorship-deep-dive-v2.md` | Shortened, focused version |
| 14 | **Image** 🟡 Recommended | Sponsorship activation pyramid | 1 min | Upload `sponsorship-activation-pyramid.png` | From logo to integration |
| 15 | **Details** 🟢 Optional | Sponsorship ROI measurement (200 words) | 1 min | Type directly | Accordion for optional depth |
| 16 | **Text** 🔴 Required | Merchandising & Betting (400 words) | 3 min | Import `week1-merchandising-betting-v2.md` | Shortened, combined |
| 17 | **Infobox (Insight)** 🟡 Recommended | Betting growth statistics callout | 1 min | Type directly | Purple variant, data highlight |
| 18 | **Text** 🔴 Required | Revenue Ecosystem Principle (350 words) | 2 min | Import `week1-revenue-interdependence-v2.md` | Shortened synthesis |
| 19 | **Image** 🟡 Recommended | Revenue ecosystem diagram | 1 min | Upload `revenue-ecosystem-diagram.png` | Visual synthesis |
