...
- ☐ All widgets meet WCAG 2.2 AA (keyboard nav, ARIA labels, screen reader compatible)
...
- ☐ Test all widgets for accessibility compliance
- ☐ Test all videos have working captions
...
- **Text imports:** 2 documents (intro, Canucks case)
- **Text typed directly:** 30+ sections (all Module 3 micro-readings, connection text, preview)
- **Videos:** 3 total (1 executive 90-min, 2 instructional 2-min each)
- **Tiles:** 2 sets (4 tiles Module 1, 3 tiles Module 3)
