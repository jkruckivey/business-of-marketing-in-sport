...
| 5 | **▬ Text** ⬤ Required | **Phase 2A: Peer Feedback Instructions** | Type directly | How to review classmate's draft |
| 6 | **▬ Text** ⬤ Required | **Phase 2B: AI Feedback Instructions** | Type directly | ChatGPT prompt + process |
| 7 | **▬ Text** ⬤ Required | **Phase 3: Comparative Reflection** | Type directly | Compare peer vs. AI feedback |
| 8 | **▬ Text** ⬤ Required | **Phase 5: Post-Revision Reflection** | Type directly | Reflect on revision choices |
| 9 | **📄 File Attachment** ⬤ Required | Assessment rubric with bonus structure | Attach PDF | 100 pts + 5 pt bonus |
| 10 | **💬 Text Submission** ⬤ Required | Draft memo submission (Phase 1) | Configure in Uplimit | 80% version for feedback |
| 11 | **💬 Text Submission** ⬤ Required | Peer feedback submission | Configure in Uplimit | Feedback for classmate (2 pts bonus) |
| 12 | **💬 Text Submission** ⬤ Required | AI feedback submission | Configure in Uplimit | ChatGPT response (1 pt bonus) |
| 13 | **💬 Text Submission** ⬤ Required | Comparative reflection submission | Configure in Uplimit | 300-400 words (1 pt bonus) |
| 14 | **💬 Text Submission** ⬤ Required | Final revised memo submission (Phase 4) | Configure in Uplimit | Incorporates feedback |
| 15 | **💬 Text Submission** ⬤ Required | Post-revision reflection submission | Configure in Uplimit | 200-300 words (1 pt bonus) |
